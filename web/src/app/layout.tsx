...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      title,
      description,
      images: [{ url: `${siteUrl}/${isEn ? 'og-image-en.jpg' : 'og-image-v2.jpg'}`, width: 1200, height: 630, alt: title }],
    },
    twitter: { card: 'summary_large_image', title, description, images: [`${siteUrl}/${isEn ? 'og-image-en.jpg' : 'og-image-v2.jpg'}`] },
