  ...
  return [
    {
      ...
      shortDesc: "2026학년도 수능 영어 실제 출제 단어 521개 완벽 분석. 듣기·2점 독해·3점 독해 영역별로 분류해 시험에 나온 단어만 집중 학습. 수능 직전 마무리에 최적화된 단어장.",
      price: 3900,
      durationDays: 180,
      badge: "BEST",
      isComingSoon: false,
    ...
    },
    {
      ...
      name: "EBS 연계어휘 완전정복",
      slug: "ebs-vocab",
      shortDesc: "수능 연계 교재 3종(영어듣기·영어·영어독해연습) 핵심 어휘 3,837개. EBS에서 나오면 수능에 나온다 — 연계율 70% 완벽 대비.",
      price: 6900,
      durationDays: 180,
      badges: ["NEW", "대용량"],
      isComingSoon: false,
    ...
    },
    {
      ...
      name: "TOEFL 완전정복",
      slug: "toefl-complete",
      shortDesc: "세계 6,000개 이상 대학이 요구하는 TOEFL. Core 기본필수부터 Advanced 실전 고난도까지 3,651개 완전 정복. Greek·Latin 어원 기반으로 한 번 외우면 절대 잊히지 않는다.",
      price: 9900,
      durationDays: 180,
      badge: "NEW",
      isComingSoon: false,
    ...
    },
    {
      ...
      name: "TOEIC 점수폭발",
      slug: "toeic-complete",
      shortDesc: "취업·승진을 결정짓는 TOEIC. Starter 기초부터 Booster 고득점까지 2,491개 핵심 어휘만 골라담았다. AI 이미지로 외우면 시험장에서 잊히지 않는다.",
      price: 9900,
      durationDays: 180,
      badge: "NEW",
      isComingSoon: false,
    ...
    },
    {
      ...
      name: "SAT 핵심 어휘",
      slug: "sat-complete",
      shortDesc: "미국 대학 입시의 관문, SAT 어휘를 단기간에 완성. Greek·Latin 어근 기반 테마별 핵심어휘(L1)와 혼동하기 쉬운 어휘(L2)로 1,935개를 체계적으로 정복.",
      price: 9900,
      durationDays: 180,
      badge: "NEW",
      isComingSoon: false,
