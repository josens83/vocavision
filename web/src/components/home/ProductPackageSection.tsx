...
function getStaticPackages(isEn: boolean): ProductPackage[] {
  return [
    ...
    },
    {
      ...
      slug: "act-complete",
      shortDesc: isEn
        ? "Score higher on ACT English & Reading. 750+ words across Core Meaning, Tone & Attitude, Transitions, Science Reasoning, and Academic verbs \u2014 the exact skills ACT tests."
        : "ACT 핵심 어휘 750+개 — Core, Tone, Transition, Academic, Confusable 5개 카테고리를 AI 이미지·어원·라임으로 단기 완성.",
      price: 6900,
      durationDays: 180,
      badge: "NEW",
      isComingSoon: false,
...
export default function ProductPackageSection() {
  ...
  const englishShortDescs: Record<string, string> = {
    ...
    'act-complete': 'Score higher on ACT English & Reading. 750+ words across Core Meaning, Tone & Attitude, Transitions, Science Reasoning, and Academic verbs \u2014 the exact skills ACT tests.',
