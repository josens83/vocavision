...
const featuresKo = [
  ...
  { icon: Icons.BookOpen, title: "스마트 플래시카드", description: "과학적 간격 반복으로 효율적 암기", href: "/help", demoHref: "/help" },
...
const featuresEn = [
  ...
  { icon: Icons.BookOpen, title: "Smart Flashcards", description: "Scientifically proven spaced repetition", href: "/help", demoHref: "/help" },
