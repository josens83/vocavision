...
export const guestNavigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "2026 기출 분석", labelEn: "2026 CSAT Analysis", href: "/auth/register?from=csat2026" },
      { label: "EBS 연계어휘", labelEn: "EBS Vocabulary", href: "/auth/register?from=ebs" },
      { label: "TOEFL 완전정복", labelEn: "TOEFL Core Vocabulary", href: "/packages/toefl-complete" },
      { label: "TOEIC 점수폭발", labelEn: "TOEIC Score Booster", href: "/packages/toeic-complete" },
      { label: "SAT 핵심 어휘", labelEn: "SAT Advanced Vocabulary", href: "/packages/sat-complete" },
      { label: "GRE 완전정복", labelEn: "GRE Verbal Mastery", href: "/packages/gre-complete" },
      { label: "IELTS 완전정복", labelEn: "IELTS Academic Mastery", href: "/packages/ielts-complete" },
    ],
  },
  {
    label: "요금제",
...
export const authNavigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "2026 기출 분석", labelEn: "2026 CSAT Analysis", href: "/dashboard?exam=CSAT_2026" },
      { label: "EBS 연계어휘", labelEn: "EBS Vocabulary", href: "/dashboard?exam=EBS" },
      { label: "TOEFL 완전정복", labelEn: "TOEFL Core Vocabulary", href: "/dashboard?exam=TOEFL" },
      { label: "TOEIC 점수폭발", labelEn: "TOEIC Score Booster", href: "/dashboard?exam=TOEIC" },
      { label: "SAT 핵심 어휘", labelEn: "SAT Advanced Vocabulary", href: "/dashboard?exam=SAT" },
      { label: "GRE 완전정복", labelEn: "GRE Verbal Mastery", href: "/dashboard?exam=GRE" },
      { label: "IELTS 완전정복", labelEn: "IELTS Academic Mastery", href: "/dashboard?exam=IELTS" },
    ],
  },
  {
    label: "내 학습",
