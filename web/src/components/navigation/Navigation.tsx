...
export const guestNavigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "EBS 연계 핵심 어휘", href: "/auth/register?from=ebs" },
      { label: "TOEFL Core Vocabulary", href: "/packages/toefl-complete" },
      { label: "TOEIC Score Booster", href: "/packages/toeic-complete" },
      { label: "SAT Advanced Vocabulary", href: "/packages/sat-complete" },
      { label: "GRE Verbal Mastery", href: "/packages/gre-complete" },
      { label: "IELTS Academic Mastery", href: "/packages/ielts-complete" },
    ],
  },
  {
    label: "요금제",
...
export const authNavigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "EBS 연계 핵심 어휘", href: "/dashboard?exam=EBS" },
      { label: "TOEFL Core Vocabulary", href: "/dashboard?exam=TOEFL" },
      { label: "TOEIC Score Booster", href: "/dashboard?exam=TOEIC" },
      { label: "SAT Advanced Vocabulary", href: "/dashboard?exam=SAT" },
      { label: "GRE Verbal Mastery", href: "/dashboard?exam=GRE" },
      { label: "IELTS Academic Mastery", href: "/dashboard?exam=IELTS" },
    ],
  },
  {
    label: "내 학습",
