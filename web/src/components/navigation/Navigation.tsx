...
export const guestNavigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "EBS 연계어휘", href: "/auth/register?from=ebs" },
      ...
      { label: "IELTS 완전정복", href: "/packages/ielts-complete" },
    ],
  },
  {
    label: "요금제",
...
export const authNavigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "EBS 연계어휘", href: "/dashboard?exam=EBS" },
      ...
      { label: "IELTS 완전정복", href: "/dashboard?exam=IELTS" },
    ],
  },
  {
    label: "내 학습",
